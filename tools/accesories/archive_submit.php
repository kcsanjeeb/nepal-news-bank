        ...
        { 
            if( !empty($_POST['title']) && !empty($_POST['date']) )
            {
                    ...
                    {     
                        ...
                        mkdir('../'.$archive_path_video.'/'.$title_directory, 0777 , true);
                        
                        chmod('../'.$archive_path_video.'/'.$title_directory, 0777);
                    ...
                    //  echo "<br>";
                        ...
                        foreach($series_final_array as $sr)
                        {
                            ...
                            $curl = curl_init();
                                curl_setopt_array($curl, array(                    
                                CURLOPT_URL => "$domain_url/wp-json/wp/v2/haru_series/$sr",
                                CURLOPT_RETURNTRANSFER => true,
                                CURLOPT_TIMEOUT => 30,
                                CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
