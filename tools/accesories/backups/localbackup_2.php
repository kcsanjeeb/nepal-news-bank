...
if(isset($_POST['submit']))
{
    ...
    if(($isset_valid == 1 && $isempty_valid == 1) || ($isset_valid_int == 1 && $isempty_valid_int == 1) )
    {
        ...
        if(count($_FILES['videoLongFile']) == 1)
        {
        ...
        else
        {
            ...
            $news_long_lazy_valid = true; // nwws to validate later same name condition in video long and lazu
         
            

            if($isset_valid_int == 1 && $isempty_valid_int == 1)
            {
                $gallery_status = true ;     
            }
            ...
            if(is_dir('../'.$newsdate))
            {
               echo " $byline_lenght_status && $news_lang_status && $news_long_lazy_valid && $newsbody_status && $video_long_status &&  $thumbImg_status  &&  $videoLazy_status && $gallery_status && $audio_status && $videoExtra_status";
