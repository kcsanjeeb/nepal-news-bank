    ...
    if(isset($_GET['news_id']) && !empty($_GET['news_id']))
    {
        ...
        {  
            ...
            else
            {
                ...
                CURLOPT_URL => $domain_url."/wp-json/wp/v2/haru_video/$wp_post_id",
                ...
                // echo "POST $data-------------$respCode----";
                // echo "<br>".$domain_url."/wp-json/wp/v2/haru_video/$wp_post_id";
                // echo "----------------------------------------";
               


               
                $series_nas_new = $_GET['new_series'];

                    if($series_nas != null)
                    {
                            $series_nas_exp = explode("," , $series_nas_new);
                        ...
                        {
                            $response['cmb2']['haru_series_attached_videos_field']['haru_series_attached_videos'] = array($wp_post_id);
                        }
                        else
                        {
                            array_push($response['cmb2']['haru_series_attached_videos_field']['haru_series_attached_videos'] , $wp_post_id);
