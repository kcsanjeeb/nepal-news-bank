                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <div class="nav card list-group list-group-flush sidebar_byline flex-column nav-pills"
                                ...
                                <a class="nav-link list-group-item p-2 <?php echo  $active_id ; ?> preloader_on"
                        ...
                        <div class="col-9">
                            ...
                            <form method="POST" action="accesories/remote_submit.php">
                                ...
                                <button type="submit" class="btn btn-info sub_push preloader_on"
                            ...
                            <div style="display:flex">
                                <span class="mr-2">
                                    <form method="POST" action="accesories/wp_post_create.php">
                                        <input type="hidden" name="news_id" value="<?php echo $content_id ; ?>">
                                        <button class="btn btn-info preloader_on"
                                            style="cursor:<?php echo  $curs_style_create ; ?>; "
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 ">
                                <form method="GET" class="btn-group">
                                    ...
                                    <button type="button btn-sm" class="btn btn-outline-light preloader_on">Submit</button>
                                </form>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Delete Post and Remote Files</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            Are you sure you want to delete Remote News and Files"<strong>
                                                <?php echo $top_byline ; ?>" ?
                                            </strong>
                                        </div>
    ...
    $(document).on('click', '.post_type', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // $("#preloader_boot").css("display", "none");
